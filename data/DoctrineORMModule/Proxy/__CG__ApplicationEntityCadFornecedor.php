 ...
 */
class CadFornecedor extends \Application\Entity\CadFornecedor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'PK_fornecedor', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'FK_usuario', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'xNome', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'xFant', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'CNPJ_CPF', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'xLgr', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'fone', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'nro', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'xBairro', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'cMun', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'UF', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'CEP', '' . "\0" . 'Application\\Entity\\CadFornecedor' . "\0" . 'IE');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CadFornecedor $proxy) {
    ...
    public function getPK_fornecedor()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPK_fornecedor', array());

        return parent::getPK_fornecedor();
    }
    ...
    public function setPK_fornecedor($PK_fornecedor)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPK_fornecedor', array($PK_fornecedor));

        return parent::setPK_fornecedor($PK_fornecedor);
    }
